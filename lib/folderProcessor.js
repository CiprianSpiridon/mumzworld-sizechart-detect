...
async function processSkuFolder(skuPath) {
    try {
        ...
        return {
            ...
            'image 1 confidence': confidences[0] || 0,
            'image 2 confidence': confidences[1] || 0,
            'image 3 confidence': confidences[2] || 0
        };
    } catch (error) {
    ...
    try {
        ...
        return new Promise((resolve, reject) => {
            ...
            const finalResults = results.map(row => ({
                ...
                'image 1 confidence': row['image 1 confidence'],
                'image 2 confidence': row['image 2 confidence'],
                'image 3 confidence': row['image 3 confidence']
            }));
